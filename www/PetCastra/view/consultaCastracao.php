...
<body>
    ...
    <div class="container-fluid bg-dark" style="grid-area: footer;">
        <div class="row h-100 align-items-center">
            <div class="px-5">
                <?php if ($_SESSION["dadosLogin"]->nivelacesso == 1) {
                    echo "<a href='" . URL . "home-clinica' class='btn btn-success'>Voltar</a>";
                } ?>
                <?php if ($_SESSION["dadosLogin"]->nivelacesso == 2) {
                        ...
                        <div class='modal-content'>
                            <form action='" . URL . "atualizar-castracao' method='post'>
                                ...
                                <div class='modal-body'>
                                    ...
                                    <div class='form-group mb-4' id='codChipWrapper'>
                                    ...
                                    <div class='form-group mb-4 my-3' id='dataCastracaoWrapper'>
                                        <label class='form-label' for='dataCastracao'>Nova data de castração:</label>
                                        <input type='datetime-local' name='dataCastracao' id='dataCastracao' class='form-control'>
                                    </div>
    ...
    <script>
        const toggleInputs = (statusCastracao) => {
            const dataCastracaoWrapper = document.getElementById('dataCastracaoWrapper');
            const codChipWrapper = document.getElementById('codChipWrapper');

            /* 
             * caso o statusCastracao seja igual a 6, "Reagendar Castração", o campo dataCastracao será habilitado e codChip será desabilitado
             * caso o statusCastracao seja diferente de 6, "Reagendar Castração", o campo dataCastracao será desabilitado e codChip será habilitado
             */
            if (statusCastracao == 6) {
                dataCastracaoWrapper.style.display = 'block';
                dataCastracaoWrapper.required = true;
                codChipWrapper.style.display = 'none';
                codChipWrapper.required = false;
            } else {
                dataCastracaoWrapper.style.display = 'none';
                codChipWrapper.style.display = 'block';
                dataCastracaoWrapper.required = false;
        ...
        modal.addEventListener('show.bs.modal', function(event) {
            ...
            const selectStatusAtualizado = document.getElementById('statusAtualizado');

            toggleInputs(status);

            selectStatusAtualizado
                .addEventListener('change', (event) => toggleInputs(event.target.value));
    ...
    <script>
        ...
        btnCancelar.setAttribute('color', 'green');
    </script>
