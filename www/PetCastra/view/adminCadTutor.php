            ...
            <div class="row h-100 align-items-center">
                <div class="py-3 px-2">
                    <div class="container bg-dark text-light font-weight-bold p-3">
                        <h5 class="m-0">Cadastrar Tutor</h5>
                    </div>
                    <div class="container p-sm-3 p-md-3 p-lg-4 p-3 bg-white">
                        <form method="post" class="p-sm-3 p-md-3 p-lg-4 p-3 px-0 row m-0" action="admin-cadastrar-tutor" enctype="multipart/form-data">
                            <div class="col-md-6 mb-lg-0 mb-5 p-0 pe-md-3">
                                ...
                                <div class="row mb-3">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <label for="chkNIS" class="form-label">Beneficiário NIS</label>
                                    </div>
                                    <div class="form-group col-sm-6">
